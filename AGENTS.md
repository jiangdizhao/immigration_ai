...
- On Rico's Ubuntu laptop, run backend validation with `/home/rico/anaconda3/envs/torch/bin/python`; confirm that exact executable and Python >=3.11 before testing. Do not use, create, install into, or modify another Conda environment as a workaround without approval.
