...
class CaseFrameService:
    ...
    COMMON_500_FACTS = (
        ...
        "student_visa_expiry_status",
        "last_substantive_visa",
        "visa_ceased_date",
        "application_timing",
        "bridging_status",
        ...
        "coe_or_enrolment_status",
        "course_type",
        "provider_name",
        "study_purpose",
        "course_progression_logic",
        "immigration_history",
        "previous_visa_compliance",
        ...
        "age",
        "school_year_level",
        "family_member_question",
        "family_member_type",
        "relationship_status",
        "combined_application",
        "subsequent_entry",
        "dependent_child_age",
        "dependent_child_school_age",
        "education_arrangement",
        "secondary_financial_capacity_evidence",
        "family_oshc_status",
        "condition_numbers",
        "condition_8208_applies",
        "condition_8105_applies",
        "condition_8104_applies",
        "condition_8202_applies",
        "work_hours_issue",
        "work_hours_per_fortnight",
        "course_in_session",
        "attendance_warning",
        "attendance_rate",
        "attendance_or_course_progress_issue",
        "course_progress_issue",
        "course_progress_warning",
        "school_warning",
        "provider_warning",
        "provider_reported",
        "home_affairs_notice_received",
        "noicc_received",
        "cancellation_decision_received",
        "home_affairs_decision_or_notice_type",
        "health_issue",
        "character_issue",
        "debt_issue",
        "pic4020_issue",
        "minor_welfare_issue",
        "document_checklist_requested",
        "critical_technology_context",
        "research_topic",
        "course_change_or_research_topic_change",
    )
    ...
    def __init__(self) -> None:
        ...
        self.frames: dict[str, CaseFrameDefinition] = {
            ...
            "student_500_application_readiness": CaseFrameDefinition(
                frame_id="student_500_application_readiness",
                case_family="student_visa",
                operation_type="student_500_application_readiness",
                user_goal="student_visa_application_readiness",
                issue_type="student_visa",
                visa_type="student",
                response_tier="provisional_recommendation",
                valid_fact_keys=self.COMMON_500_FACTS,
                askable_fact_keys=("coe_or_enrolment_status", "current_location", "current_visa"),
                forbidden_fact_keys=refusal_forbidden,
                default_next_question_en="Do you already have a CoE or offer/enrolment evidence for the course?",
                default_next_question_zh="你是否已经拿到 CoE 或课程 offer/enrolment 证明？",
                risk_level="medium",
                live_current_sensitive=True,
            ),
            "student_500_schedule1_validity_or_onshore_lodgement": CaseFrameDefinition(
                frame_id="student_500_schedule1_validity_or_onshore_lodgement",
                case_family="student_visa",
                operation_type="student_500_schedule1_validity_or_onshore_lodgement",
                user_goal="valid_lodgement_and_onshore_status_check",
                issue_type="student_visa",
                visa_type="student",
                response_tier="provisional_recommendation",
                valid_fact_keys=self.COMMON_500_FACTS,
                askable_fact_keys=("current_location", "current_visa", "application_timing"),
                forbidden_fact_keys=refusal_forbidden,
                default_next_question_en="Are you currently in Australia, and what visa do you hold now?",
                default_next_question_zh="你现在人在澳洲境内吗？目前持有什么签证？",
                risk_level="medium",
                live_current_sensitive=True,
            ),
            "student_500_genuine_student_risk": CaseFrameDefinition(
                frame_id="student_500_genuine_student_risk",
                case_family="student_visa",
                operation_type="student_500_genuine_student_risk",
                user_goal="genuine_student_risk_assessment",
                issue_type="student_visa",
                visa_type="student",
                response_tier="provisional_recommendation",
                valid_fact_keys=self.COMMON_500_FACTS,
                askable_fact_keys=("course_type", "study_purpose", "immigration_history"),
                forbidden_fact_keys=refusal_forbidden,
                default_next_question_en="What course do you plan to study, and why does it fit your study or career pathway?",
                default_next_question_zh="你计划读什么课程？它和你的学习或职业路径有什么关系？",
                risk_level="medium",
                live_current_sensitive=True,
            ),
            "student_500_financial_english_oshc_requirements": CaseFrameDefinition(
                frame_id="student_500_financial_english_oshc_requirements",
                case_family="student_visa",
                operation_type="student_500_financial_english_oshc_requirements",
                user_goal="common_student_visa_evidence_requirements",
                issue_type="student_visa",
                visa_type="student",
                response_tier="provisional_recommendation",
                valid_fact_keys=self.COMMON_500_FACTS,
                askable_fact_keys=("financial_capacity_evidence", "english_requirement_status", "oshc_status"),
                forbidden_fact_keys=refusal_forbidden,
                default_next_question_en="Are you mainly asking about funds, English evidence, or OSHC/health insurance?",
                default_next_question_zh="你主要想问资金证明、英语要求，还是 OSHC/医疗保险？",
                risk_level="medium",
                live_current_sensitive=True,
            ),
            "student_500_family_secondary_applicant": CaseFrameDefinition(
                frame_id="student_500_family_secondary_applicant",
                case_family="student_visa",
                operation_type="student_500_family_secondary_applicant",
                user_goal="family_member_or_secondary_applicant_triage",
                issue_type="student_visa",
                visa_type="student",
                response_tier="provisional_recommendation",
                valid_fact_keys=self.COMMON_500_FACTS,
                askable_fact_keys=("family_member_type", "relationship_status", "combined_application"),
                forbidden_fact_keys=refusal_forbidden,
                default_next_question_en="Is the family member your partner/spouse or child, and will they apply with you or later?",
                default_next_question_zh="家属是你的配偶/伴侣还是孩子？他们会和你一起申请还是之后申请？",
                risk_level="medium",
                live_current_sensitive=True,
            ),
            "student_500_conditions_explainer": CaseFrameDefinition(
                frame_id="student_500_conditions_explainer",
                case_family="student_visa",
                operation_type="student_500_conditions_explainer",
                user_goal="student_visa_condition_explanation",
                issue_type="visa_conditions",
                visa_type="student",
                response_tier="provisional_recommendation",
                valid_fact_keys=self.COMMON_500_FACTS,
                askable_fact_keys=("condition_numbers",),
                forbidden_fact_keys=refusal_forbidden,
                default_next_question_en="Which visa condition do you want to understand, for example 8105, 8202, 8501 or 8208?",
                default_next_question_zh="你想了解哪个签证条件，例如 8105、8202、8501 或 8208？",
                risk_level="medium",
                live_current_sensitive=True,
            ),
            "student_500_work_rights_or_hours_risk": CaseFrameDefinition(
                frame_id="student_500_work_rights_or_hours_risk",
                case_family="student_visa",
                operation_type="student_500_work_rights_or_hours_risk",
                user_goal="work_rights_or_hours_risk_assessment",
                issue_type="student_visa",
                visa_type="student",
                response_tier="provisional_recommendation",
                valid_fact_keys=self.COMMON_500_FACTS,
                askable_fact_keys=("work_hours_per_fortnight", "course_in_session", "home_affairs_notice_received"),
                forbidden_fact_keys=refusal_forbidden,
                default_next_question_en="Have you received a formal Home Affairs notice, or only a school/employer warning?",
                default_next_question_zh="你收到的是 Home Affairs 正式通知，还是学校/雇主提醒？",
                risk_level="high",
                live_current_sensitive=True,
            ),
            "student_500_attendance_course_progress_risk": CaseFrameDefinition(
                frame_id="student_500_attendance_course_progress_risk",
                case_family="student_visa",
                operation_type="student_500_attendance_course_progress_risk",
                user_goal="attendance_or_course_progress_risk_assessment",
                issue_type="student_visa",
                visa_type="student",
                response_tier="provisional_recommendation",
                valid_fact_keys=self.COMMON_500_FACTS,
                askable_fact_keys=("attendance_rate", "course_progress_warning", "home_affairs_notice_received"),
                forbidden_fact_keys=refusal_forbidden,
                default_next_question_en="Have you received a formal Home Affairs notice, or only a provider/school warning?",
                default_next_question_zh="你收到的是 Home Affairs 正式通知，还是学校/provider 的警告？",
                risk_level="high",
                live_current_sensitive=True,
            ),
            "student_500_provider_warning_or_home_affairs_notice": CaseFrameDefinition(
                frame_id="student_500_provider_warning_or_home_affairs_notice",
                case_family="student_visa",
                operation_type="student_500_provider_warning_or_home_affairs_notice",
                user_goal="distinguish_provider_warning_from_formal_notice",
                issue_type="student_visa",
                visa_type="student",
                response_tier="provisional_recommendation",
                valid_fact_keys=self.COMMON_500_FACTS + self.COMMON_REFUSAL_FACTS,
                askable_fact_keys=("home_affairs_notice_received", "noicc_received", "cancellation_decision_received"),
                forbidden_fact_keys=(),
                default_next_question_en="Was it a school/provider warning, a NOICC, or an actual Home Affairs cancellation decision?",
                default_next_question_zh="这是学校/provider 警告、NOICC/拟取消通知，还是 Home Affairs 已经作出的取消决定？",
                risk_level="high",
                live_current_sensitive=True,
            ),
            "student_500_course_change_provider_or_research_change": CaseFrameDefinition(
                frame_id="student_500_course_change_provider_or_research_change",
                case_family="student_visa",
                operation_type="student_500_course_change_provider_or_research_change",
                user_goal="course_provider_or_research_topic_change_check",
                issue_type="student_visa",
                visa_type="student",
                response_tier="provisional_recommendation",
                valid_fact_keys=self.COMMON_500_FACTS,
                askable_fact_keys=("course_type", "course_change_or_research_topic_change", "condition_8208_applies"),
                forbidden_fact_keys=refusal_forbidden,
                default_next_question_en="Are you changing course/provider or starting/changing a postgraduate research topic?",
                default_next_question_zh="你是要换课程/学校，还是开始或更改研究型课题？",
                risk_level="medium",
                live_current_sensitive=True,
            ),
            "student_500_current_policy_sensitive_question": CaseFrameDefinition(
                frame_id="student_500_current_policy_sensitive_question",
                case_family="student_visa",
                operation_type="student_500_current_policy_sensitive_question",
                user_goal="current_student_visa_policy_check",
                issue_type="student_visa",
                visa_type="student",
                response_tier="provisional_recommendation",
                valid_fact_keys=self.COMMON_500_FACTS,
                askable_fact_keys=("course_type", "condition_numbers", "financial_capacity_evidence"),
                forbidden_fact_keys=refusal_forbidden,
                default_next_question_en="Which current Student visa rule are you worried about: GS, funds, English, work rights, conditions or research/critical technology?",
                default_next_question_zh="你担心的是哪个当前学生签规则：GS、资金、英语、工作权利、签证条件，还是研究/关键技术？",
                risk_level="medium",
                live_current_sensitive=True,
            ),
            "student_500_critical_technology_or_condition_8208": CaseFrameDefinition(
                frame_id="student_500_critical_technology_or_condition_8208",
                case_family="student_visa",
                operation_type="student_500_critical_technology_policy_check",
                user_goal="critical_technology_condition_8208_or_pic4003b_check",
                issue_type="student_visa",
                visa_type="student",
                response_tier="provisional_recommendation",
                valid_fact_keys=self.COMMON_500_FACTS,
                askable_fact_keys=("course_type", "research_topic", "condition_8208_applies"),
                forbidden_fact_keys=refusal_forbidden,
                default_next_question_en="Is this a postgraduate research course or research topic involving critical technology such as AI, cyber security, quantum or advanced computing?",
                default_next_question_zh="这是涉及 AI、网络安全、量子或先进计算等关键技术的研究型课程或研究课题吗？",
                risk_level="high",
                live_current_sensitive=True,
            ),
            "student_500_expiry_extension_or_status_risk": CaseFrameDefinition(
                frame_id="student_500_expiry_extension_or_status_risk",
                case_family="student_visa",
                operation_type="500_expiry_or_extension",
                user_goal="student_visa_expiry_extension_or_status_risk",
                issue_type="student_visa",
                visa_type="student",
                response_tier="urgent_provisional_recommendation",
                valid_fact_keys=self.COMMON_500_FACTS + self.COMMON_485_FACTS,
                askable_fact_keys=("student_visa_expiry_date", "current_location", "bridging_status"),
                forbidden_fact_keys=refusal_forbidden,
            ...
            "student_500_transition_to_485": CaseFrameDefinition(
                frame_id="student_500_transition_to_485",
                case_family="student_visa",
                operation_type="student_500_transition_to_485",
                user_goal="student_500_to_485_transition_check",
                issue_type="student_visa",
                visa_type="student",
                response_tier="urgent_provisional_recommendation",
                valid_fact_keys=self.COMMON_500_FACTS + self.COMMON_485_FACTS,
                askable_fact_keys=("course_completion_status", "student_visa_expired_days", "lodged_485_already"),
                forbidden_fact_keys=refusal_forbidden,
                default_next_question_en="Have you already lodged a 485 application, and what does VEVO show now?",
                default_next_question_zh="你是否已经递交 485？VEVO 现在显示什么状态？",
                risk_level="high",
                live_current_sensitive=True,
            ),
            "student_500_cancellation_noicc_or_s48_risk": CaseFrameDefinition(
                frame_id="student_500_cancellation_noicc_or_s48_risk",
                case_family="refusal_review",
                operation_type="student_500_cancellation_noicc_or_s48_risk",
                user_goal="student_visa_cancellation_noicc_or_review_risk",
                issue_type="visa_cancellation",
                visa_type="student",
                response_tier="warning_answer",
                valid_fact_keys=self.COMMON_500_FACTS + self.COMMON_REFUSAL_FACTS,
                askable_fact_keys=("home_affairs_decision_or_notice_type", "notification_date", "noicc_received"),
                forbidden_fact_keys=(),
                default_next_question_en="Was it a NOICC/proposed cancellation notice, or an actual cancellation decision?",
                default_next_question_zh="这是 NOICC/拟取消通知，还是已经作出的取消决定？",
                risk_level="high",
                live_current_sensitive=True,
            ),
            "student_500_health_character_pic_or_integrity_risk": CaseFrameDefinition(
                frame_id="student_500_health_character_pic_or_integrity_risk",
                case_family="student_visa",
                operation_type="student_500_health_character_pic_or_integrity_risk",
                user_goal="public_interest_or_integrity_risk_check",
                issue_type="student_visa",
                visa_type="student",
                response_tier="provisional_recommendation",
                valid_fact_keys=self.COMMON_500_FACTS,
                askable_fact_keys=("health_issue", "character_issue", "pic4020_issue"),
                forbidden_fact_keys=refusal_forbidden,
                default_next_question_en="Is your concern about health, character, false information/PIC 4020, debt, or another integrity issue?",
                default_next_question_zh="你担心的是健康、品格、虚假材料/PIC 4020、债务，还是其他诚信问题？",
                risk_level="high",
                live_current_sensitive=True,
            ),
            "student_500_document_checklist": CaseFrameDefinition(
                frame_id="student_500_document_checklist",
                case_family="student_visa",
                operation_type="student_500_document_checklist",
                user_goal="student_visa_document_checklist",
                issue_type="student_visa",
                visa_type="student",
                response_tier="provisional_recommendation",
                valid_fact_keys=self.COMMON_500_FACTS,
                askable_fact_keys=("course_type", "family_member_type", "current_location"),
                forbidden_fact_keys=refusal_forbidden,
                default_next_question_en="Is this document checklist for a primary student applicant or a family member?",
                default_next_question_zh="这份材料清单是给主申请人，还是给家属/副申请人？",
                risk_level="medium",
                live_current_sensitive=True,
            ),
    ...
    def _frame_description(self, definition: CaseFrameDefinition) -> str:
        ...
        if definition.frame_id == "student_500_application_readiness":
            return "Student visa 500 application readiness: CoE/enrolment, GS, funds, English, OSHC and Schedule 1 validity."
        if definition.frame_id == "student_500_schedule1_validity_or_onshore_lodgement":
            return "Student visa 500 valid-lodgement and onshore application/status question."
        if definition.frame_id == "student_500_genuine_student_risk":
            return "Student visa 500 Genuine Student/study-purpose/course-progression risk."
        if definition.frame_id == "student_500_financial_english_oshc_requirements":
            return "Student visa 500 common evidence requirements: funds, English and OSHC."
        if definition.frame_id == "student_500_family_secondary_applicant":
            return "Student visa 500 spouse/partner/child/dependent or secondary applicant question."
        if definition.frame_id == "student_500_conditions_explainer":
            return "Student visa 500 condition explanation such as 8105, 8104, 8202, 8501 or 8208."
        if definition.frame_id == "student_500_work_rights_or_hours_risk":
            return "Student visa 500 work rights/work-hour limit issue."
        if definition.frame_id == "student_500_attendance_course_progress_risk":
            return "Student visa 500 attendance, enrolment or course-progress issue."
        if definition.frame_id == "student_500_provider_warning_or_home_affairs_notice":
            return "Distinguish provider/school warning, NOICC, Home Affairs notice, and actual cancellation decision."
        if definition.frame_id == "student_500_course_change_provider_or_research_change":
            return "Student visa 500 course/provider change or postgraduate research-topic change."
        if definition.frame_id == "student_500_current_policy_sensitive_question":
            return "Current-policy-sensitive Student visa 500 question: GS, funds, English, work rights, conditions, research or other current rule."
        if definition.frame_id == "student_500_critical_technology_or_condition_8208":
            return "Student visa 500 critical technology, condition 8208, PIC 4003B, PhD/research, AI/cybersecurity/quantum issue."
        if definition.frame_id == "student_500_expiry_extension_or_status_risk":
            return "Student visa 500 expiry, extension, bridging or unlawful-status risk."
        if definition.frame_id == "student_500_transition_to_485":
            return "Student visa 500 to Temporary Graduate 485 transition or post-study status issue."
        if definition.frame_id == "student_500_cancellation_noicc_or_s48_risk":
            return "Student visa 500 NOICC, cancellation decision, review, or related cancellation risk."
        if definition.frame_id == "student_500_health_character_pic_or_integrity_risk":
            return "Student visa 500 health, character, PIC 4020, debt or integrity risk."
        if definition.frame_id == "student_500_document_checklist":
            return "Student visa 500 document checklist for primary or secondary applicants."
