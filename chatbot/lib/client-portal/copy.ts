...
export const CLIENT_PORTAL_COPY = {
  "zh-CN": {
    ...
    assignedNo: "尚未分配",
    consultations: "咨询请求",
    consultationsUnavailable: "咨询数据暂不可用。客户中心的其他功能仍可使用。",
    consultationsVerificationRequired: "验证电子邮箱后即可使用咨询请求功能。",
    noConsultations: "暂无咨询请求。",
    requestConsultation: "为此事项提交咨询请求",
    viewConsultations: "查看咨询记录",
    conversations: "相关对话",
    membership: "会员状态",
  ...
  en: {
    ...
    consultationsUnavailable:
      "Consultation data is unavailable. Other Client Portal features remain usable.",
    consultationsVerificationRequired:
      "Verify your email address to use consultation requests.",
    noConsultations: "No consultation requests yet.",
    requestConsultation: "Request a consultation for this matter",
    viewConsultations: "View consultation history",
