...
const servicePreview = [
  {
    ...
    title: "Visa pathways",
    description:
      "Student, 485, skilled, partner, visitor, bridging, and refusal-related first-contact triage.",
    href: "/services",
  },
  {
    icon: FileCheck2,
    ...
    description:
      "Turn vague questions into decisive facts and useful consultation preparation.",
    href: "/services",
  },
  {
    icon: CalendarRange,
    ...
    description:
      "Move high-intent or high-risk visitors into a structured lawyer consultation path.",
    href: "/contact",
  },
];
          ...
          <div className="mx-auto grid w-full max-w-7xl gap-12 px-5 py-16 lg:grid-cols-[1.02fr_0.98fr] lg:px-8 lg:py-24">
            <div className="max-w-4xl">
              ...
              <p className="mt-6 max-w-2xl text-base leading-8 text-slate-200 sm:text-lg">
                A premium immigration-service website with a dedicated AI legal
                workspace. Visitors can ask migration questions, clarify facts,
                review compact source context, and move naturally into a real
                lawyer consultation.
              </p>
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  ...
                  <Card
                    className="rounded-[28px] border-white/10 bg-white/10 text-white shadow-xl backdrop-blur-xl"
                    key={label}
                  >
                  ...
                  <div className="rounded-[32px] border border-white/10 bg-[#001736]/80 p-5">
                    ...
                    <div className="space-y-3">
                      <div className="max-w-[88%] rounded-3xl bg-white/10 p-4 text-sm leading-7 text-slate-200">
                        “I am 36 and finished a master by coursework. Can I
                        still apply for a 485 visa?”
                      </div>
                      <div className="ml-auto max-w-[90%] rounded-3xl bg-cyan-300/16 p-4 text-sm leading-7 text-cyan-50">
                        I can give a focused first view, keep full eligibility
                        separate, and ask only the next decisive question.
                      </div>
                      <div className="grid gap-3 sm:grid-cols-2">
                        <div className="rounded-3xl border border-white/10 bg-white/5 p-4">
                          <p className="font-medium">Case snapshot</p>
                          <p className="mt-2 text-sm leading-6 text-slate-300">
                            Operation, confidence, next action, and intake
                            facts.
                          </p>
                        </div>
                        <div className="rounded-3xl border border-white/10 bg-white/5 p-4">
                          ...
                          <p className="mt-2 text-sm leading-6 text-slate-300">
                            Source titles without exposing raw debug panels.
                          </p>
                        </div>
                      </div>
                    </div>
          ...
          <div className="mb-9 grid gap-6 lg:grid-cols-[0.82fr_1.18fr] lg:items-end">
            <div>
              ...
              <h2 className="text-3xl font-semibold tracking-tight text-slate-950 sm:text-4xl">
                A homepage that sells the service, then routes visitors to
                purpose-built pages.
              </h2>
            </div>
            <p className="max-w-3xl text-sm leading-7 text-slate-600 sm:text-base">
              The navigation now uses real routes. The homepage previews the AI
              value proposition, while the actual chat experience, service
              catalogue, intake process, and consultation pathway each live on
              their own page.
            </p>
          </div>
            ...
            <div className="grid gap-0 lg:grid-cols-[0.86fr_1.14fr]">
              <div className="relative overflow-hidden bg-[#001736] p-8 text-white lg:p-10">
                ...
                <div className="relative">
                  <Badge
                    className="mb-5 rounded-full border-white/15 bg-white/10 text-white hover:bg-white/10"
                    variant="outline"
                  >
                  ...
                  <p className="mt-4 text-sm leading-7 text-slate-300">
                    This is closer to a commercial legal-service website: users
                    browse services, understand the process, enter the AI
                    workspace, and then convert to consultation.
                  </p>
                </div>
              </div>
                  ...
                  <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                    <div>
                      <p className="font-semibold text-slate-950">
                        Ready to test the large AI desk?
                      </p>
                      <p className="mt-1 text-sm text-slate-600">
                        Open the dedicated page rather than scrolling to an
                        anchor.
                      </p>
                    </div>
                    <Button
