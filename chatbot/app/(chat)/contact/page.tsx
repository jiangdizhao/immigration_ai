...
import { ArrowRight, CalendarRange, CheckCircle2, Clock3, Mail, MapPin, MessageSquareMore, Phone, ShieldCheck } from "lucide-react";
      ...
      <main>
        <section className="relative overflow-hidden bg-[#001736] px-5 py-16 text-white lg:px-8">
          <div
            ...
            style={{
              backgroundImage: "url('/images/sovereign-nexus/opera-house-hero.png')",
          ...
          <div className="relative mx-auto max-w-7xl">
            ...
            <h1 className="mt-5 max-w-4xl text-balance text-4xl font-semibold tracking-tight sm:text-5xl lg:text-6xl">
              Move from general AI guidance to a real immigration-law consultation.
            </h1>
            <p className="mt-5 max-w-3xl text-base leading-8 text-slate-200">
              This page is the commercial conversion point. Connect it later to your lawyer friend’s real booking system, payment provider, CRM, or calendar.
            </p>
          </div>
        </section>
        ...
        <section className="mx-auto grid max-w-7xl gap-6 px-5 py-16 lg:grid-cols-[0.92fr_1.08fr] lg:px-8">
          <div className="space-y-5">
            {contactCards.map((item) => {
              ...
              return (
                <Card className="rounded-[32px] border-slate-200 bg-white shadow-sm" key={item.title}>
                  <CardContent className="p-6">
                    ...
                    <Button asChild className="mt-5 rounded-full bg-[#001736] text-white hover:bg-[#002b5b]">
                      <Link href={item.href}>
                        {item.cta}
          ...
          <Card className="overflow-hidden rounded-[36px] border-0 bg-gradient-to-br from-[#001736] via-[#002b5b] to-[#1d0052] text-white shadow-[0_30px_110px_-42px_rgba(15,23,42,0.75)]">
            <CardContent className="p-8 lg:p-10">
              <p className="text-sm font-semibold uppercase tracking-[0.22em] text-cyan-200">Before consultation</p>
              <h2 className="mt-3 text-3xl font-semibold tracking-tight sm:text-4xl">
                Information that helps the lawyer assess the case faster.
              </h2>
              <p className="mt-4 text-sm leading-7 text-slate-200">
                The AI workspace can collect these details progressively, but the contact page should also tell visitors what to prepare.
              </p>

              <div className="mt-7 grid gap-3">
                {readiness.map((item) => (
                  <div className="flex items-start gap-3 rounded-2xl border border-white/10 bg-white/10 p-4" key={item}>
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-white/10 bg-white/10 p-4">
                  <div className="mb-2 flex items-center gap-2 text-cyan-200">
                    ...
                    <span className="text-sm font-medium text-white">Response flow</span>
                  </div>
                  <p className="text-sm leading-6 text-slate-300">AI intake first, lawyer review for specific advice.</p>
                </div>
                <div className="rounded-2xl border border-white/10 bg-white/10 p-4">
                  <div className="mb-2 flex items-center gap-2 text-cyan-200">
                    <ShieldCheck className="size-4" />
                    <span className="text-sm font-medium text-white">Safety position</span>
                  </div>
                  <p className="text-sm leading-6 text-slate-300">General information only until a qualified lawyer takes over.</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="grid gap-4 rounded-[36px] border border-slate-200 bg-white p-6 shadow-sm md:grid-cols-3">
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm leading-6 text-slate-600">Sydney / Australia migration practice positioning</p>
              </div>
            </div>
            <div className="flex gap-3">
              <Mail className="mt-1 size-5 shrink-0 text-[#002b5b]" />
              <div>
                <p className="font-semibold text-slate-950">Email placeholder</p>
                <p className="mt-1 text-sm leading-6 text-slate-600">Replace with the lawyer’s real email or contact form</p>
              </div>
            </div>
            <div className="flex gap-3">
              <Phone className="mt-1 size-5 shrink-0 text-[#002b5b]" />
              <div>
                <p className="font-semibold text-slate-950">Phone placeholder</p>
                <p className="mt-1 text-sm leading-6 text-slate-600">Replace with office phone or booking service later</p>
              </div>
            </div>
          </div>
        </section>
