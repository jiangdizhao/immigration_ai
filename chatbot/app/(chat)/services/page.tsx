...
const serviceGroups = [
  {
    ...
    summary:
      "Subclass 500, 485, post-study planning, education history, and course-completion questions.",
    bullets: [
      "Student visa refusal triage",
      "Temporary Graduate 485 stream classification",
      "Australian study and CRICOS fact collection",
    ],
  },
  {
    ...
    summary:
      "Initial pathway guidance for skilled migration, sponsor questions, occupation relevance, and document readiness.",
    bullets: [
      "Occupation and skills-assessment intake",
      "Employer-sponsored preparation",
      "Risk factors before lawyer review",
    ],
  },
  {
    icon: HeartHandshake,
    ...
    summary:
      "Front-door intake for relationship evidence, timeline concerns, sponsorship context, and consultation preparation.",
    bullets: [
      "Evidence checklist orientation",
      "Relationship timeline prompts",
  ...
  },
  {
    ...
    summary:
      "High-risk questions are guided toward decisive dates, notices, reasons, and professional advice.",
    bullets: [
      "Refusal-notice availability",
      "Review-rights and deadline triage",
      "Escalation to lawyer consultation",
    ],
  },
  {
    icon: Landmark,
    ...
    summary:
      "Plain-language explanations for bridging travel, current lawful status, and visa conditions such as 8501.",
    bullets: [
      "BVA/BVB/BVC/BVE orientation",
      "Travel and return risk prompts",
      "Visa-condition explainer route",
    ],
  },
  {
    icon: FileCheck2,
    ...
    summary:
      "The AI gathers key facts and explains what a client should prepare before meeting the lawyer.",
    bullets: [
        ...
        <section className="relative overflow-hidden bg-[#001736] px-5 py-16 text-white lg:px-8">
          ...
          <div className="relative mx-auto max-w-7xl">
            ...
            <h1 className="mt-5 max-w-4xl text-balance text-4xl font-semibold tracking-tight sm:text-5xl lg:text-6xl">
              Migration service areas that support AI-first intake and
              lawyer-led advice.
            </h1>
            <p className="mt-5 max-w-3xl text-base leading-8 text-slate-200">
              This page gives the commercial website a real service catalogue.
              The AI assistant is positioned as first-contact intake, not as a
            ...
            <CardContent className="grid gap-8 p-8 lg:grid-cols-[1.1fr_0.9fr] lg:p-10">
              <div>
                ...
                <p className="mt-4 max-w-2xl text-sm leading-7 text-slate-200">
                  A commercial site should not force every user into chat
                  immediately. This services page frames what the firm does,
                  then routes qualified visitors into the AI workspace or
                  consultation page.
                </p>
              </div>
