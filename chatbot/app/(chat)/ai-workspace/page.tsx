      ...
      <main>
        <section className="relative overflow-hidden bg-[#001736] px-5 py-14 text-white lg:px-8">
          ...
          <div className="relative mx-auto max-w-7xl">
            <p className="text-sm font-semibold uppercase tracking-[0.22em] text-cyan-200">AI legal workspace</p>
            <h1 className="mt-4 max-w-4xl text-balance text-4xl font-semibold tracking-tight sm:text-5xl">
              A full-screen migration intake desk with chat, facts, sources, and lawyer handoff.
            </h1>
            <p className="mt-5 max-w-3xl text-base leading-8 text-slate-200">
              This page is the product core. It reuses the existing backend bridge at <code className="rounded bg-white/10 px-1.5 py-0.5">/api/widget-chat</code>, but gives the assistant enough space to behave like a serious legal-service interface.
            </p>
          </div>
        </section>
